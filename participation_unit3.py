...
for index in range(max_index+1):
    chosen_name=dragon_names.pop(random.randint(0,max_index)).title()
    chosen_title=dragon_titles.pop(random.randint(0,max_index)).title()
    full_name=f"{chosen_name} {chosen_title}"
    print(full_name)
    max_index-=1
